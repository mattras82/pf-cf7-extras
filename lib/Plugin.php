	...
	protected function __construct()
	{
		...
		$this->container->bulkSet([
			...
			'settings' => function (Container &$c) {
				return new Setup\Settings($c);
			},
			'upload_path' => function (Container &$c) {
				return new Setup\UploadPath($c);
			},
			...
			'multifile' => function (Container &$c) {
				return new Inputs\MultiFile($c);
			},
			'grouped-select' => function (Container &$c) {
				return new Inputs\GroupedSelect($c);
			}
		]);
	}
